      ...
      <div className="w-[90%] mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="!text-gray-400 mb-4 max-w-md leading-relaxed">
              ...
              Practice coding problems, participate in contests, and track your progress.
            </p>
            <div className="flex gap-4">
              <a 
                href="https://github.com/Master-Bruce-Wayne/Code-It-Up" 
                className="w-10 h-10 !bg-gray-800 hover:!bg-blue-600 hover:!text-white rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="GitHub"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/problemset" className="!text-gray-400 hover:!text-blue-400 transition-colors duration-200">
                  Problemset
                </Link>
              </li>
              <li>
                <Link to="/contests" className="!text-gray-400 hover:!text-blue-400 transition-colors duration-200">
                  Contests
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="!text-gray-400 text-sm">
            © {currentYear} Code-It-Up. All rights reserved.
          </p>
